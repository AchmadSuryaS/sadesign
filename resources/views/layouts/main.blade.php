...
<head>
    ...
    <meta name="description" content="Sadesign is an expert in the field of graphic creation services. With an experienced
    creative team, we offer innovative and high-quality design solutions to meet your business's visual
    needs.">
    <meta name="keywords" content="Sadesign, SADESIGN, sadesign">
    <meta name="author" content="Sadesign">
    <title>{{ $title }}</title>
